...
This is a WIP fork of the **X-Ray Monolith Engine**. It is designed specifically for heavy modpacks (like G.A.M.M.A.) that run hundereds of scripts, require maximum stability and memory availability.
...
This build introduces a modernized memory and threading architecture to break the 15 year old limitations of the X-Ray engine:
  ...
  * **LuaJIT GC64 Implementation**
      ...
      * **2GB Hard limit increased:** Standard Anomaly crashes if the script engine uses \~2GB of RAM. This build enables 64-bit pointers in Lua, allowing the game to utilize **10GB+ of RAM** for scripts without crashing.
  ...
  * **Hybrid Multithreading Architecture**
      ...
      * Multiple systems have been upgraded to multithreaded architecture to improve 1% lows and increase FPS in CPU bound situations, providing smoother gameplay.
-----
