...
public:
  ...
  // Thread-safe version of RayQuery that uses provided context instead of class
  // members
  BOOL RayQueryParallel(collide::rq_results &dest, const collide::ray_defs &rq,
                        collide::rq_callback *cb, LPVOID user_data,
                        collide::test_callback *tb, CObject *ignore_object,
                        xrXRC &xrc_local, collide::rq_results &r_temp_local,
