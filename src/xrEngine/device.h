...
protected:
  ...
  // AVO:
  CTimer frame_timer; // TODO: ïðîâåðèòü, íå äóáëèðóåòñÿ-ëè ñõîæèé òàéìåð
                      // (alpet)
  //-AVO
...
public:
  ...
  Fvector &hud_to_world(Fvector &v) { return hud_to_world(v, mProjectHud); }
  ...
  Fmatrix &hud_to_world(Fmatrix &m) { return hud_to_world(m, mProjectHud); }
  ...
  Fvector &world_to_hud(Fvector &v) { return world_to_hud(v, mProjectHud); }
  ...
  Fmatrix &world_to_hud(Fmatrix &m) { return world_to_hud(m, mProjectHud); }
