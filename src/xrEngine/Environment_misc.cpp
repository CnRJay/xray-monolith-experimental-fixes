...
void CEnvDescriptor::load(CEnvironment &environment, CInifile &config) {
  ...
  if (config.line_exist(m_identifier.c_str(), "volumetric_intensity_factor"))
    volumetric_intensity_factor =
        config.r_float(m_identifier.c_str(), "volumetric_intensity_factor");

  if (config.line_exist(m_identifier.c_str(), "volumetric_distance_factor"))
    volumetric_distance_factor =
        config.r_float(m_identifier.c_str(), "volumetric_distance_factor");
...
void CEnvDescriptorMixer::lerp(CEnvironment *env, CEnvDescriptor &A,
