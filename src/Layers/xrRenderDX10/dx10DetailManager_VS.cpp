...
void CDetailManager::hw_Render()
{
	...
	hw_Render_dump_instanced(consts, wave.div(PI_MUL_2), dir1, prev_wave.div(PI_MUL_2), prev_dir1, 1, 0);
	...
	hw_Render_dump_instanced(consts, wave.div(PI_MUL_2), dir2, prev_wave.div(PI_MUL_2), prev_dir2, 2, 0);
	...
	hw_Render_dump_instanced(consts, wave.div(PI_MUL_2), dir2, prev_wave.div(PI_MUL_2), prev_dir2, 0, 1);
