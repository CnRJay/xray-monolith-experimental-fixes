...
private:
  ...
  mutable tbb::enumerable_thread_specific<CGraphEngine *> m_graph_engines;
  u32 m_graph_engine_max_vertex_count;
...
private:
  ...
  void create_graph_engine(CGraphEngine *&engine) const;
