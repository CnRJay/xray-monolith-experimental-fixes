...
%LJCOMPILE% /MD /DLUA_BUILD_AS_DLL lj_*.c lib_*.c xr_alloc.c
@if errorlevel 1 goto :BAD
%LJLINK% /DLL /out:%LJDLLNAME% lj_*.obj lib_*.obj xr_alloc.obj
@if errorlevel 1 goto :BAD
@goto :MTDLL
:STATIC
%LJCOMPILE% lj_*.c lib_*.c xr_alloc.c
@if errorlevel 1 goto :BAD
%LJLIB% /OUT:%LJLIBNAME% lj_*.obj lib_*.obj xr_alloc.obj
@if errorlevel 1 goto :BAD
@goto :MTDLL
:AMALGDLL
