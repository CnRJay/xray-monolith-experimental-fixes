...
class CSoundRender_Core : public CSound_manager_interface {
  ...
  std::shared_mutex m_sound_model_mutex; // Protects geom_MODEL and geom_SOM
public:
  virtual void lock_model_write() { m_sound_model_mutex.lock(); }
  virtual void unlock_model_write() { m_sound_model_mutex.unlock(); }
